...
{
    public class ZigBeeBatteryMockup : IBattery
    {
        ...
        public ZigBeeBatteryMockup(int id, IBatteryController controller, string configuration = "")
        {
            _isOnline = false;
            _isConsoleAvailable = true;
            _capacity = new Random().Next(500, 2000);
            ...
            {
                Name = $"Default ZigBee Battery {id}";
                Description = $"This is default mockup ZigBee Battery {id}";
        ...
        public string Name
        {
            ...
            set
            {
                lock (this)
                {
                    _name = value == "" ? $"Default ZigBee Battery {Id}" : value;
        ...
        public string Description
        {
            ...
            set
            {
                lock (this)
                {
                    _description = value == "" ? $"This is default mockup ZigBee Battery {Id}" : value;
